...
**Deployment Target:** HostAfrica (<root-domain>)
...
5. Enter website URL: <root-domain>
...
#    - Host: ftp.<root-domain> (or your FTP host)
...
# 5. Test: Visit https://www.<root-domain>
```
...
https://www.<root-domain>/sitemap.xml
```
