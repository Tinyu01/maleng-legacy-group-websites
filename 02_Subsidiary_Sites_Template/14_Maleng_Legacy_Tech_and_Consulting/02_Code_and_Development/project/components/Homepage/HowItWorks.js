  ...
  const steps = [
    {
      ...
      description: 'Browse our six service categories and 29+ specialized services tailored for enterprise needs',
    },
    {
      number: '02',
      icon: FaSlidersH,
    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 h-full hover:border-accent/50 transition-all duration-300">
                  <div className="absolute -top-6 -left-6 w-16 h-16 bg-gradient-to-r from-highlight to-accent text-dark rounded-full flex items-center justify-center font-bold text-2xl shadow-lg">
                    {step.number}
                  </div>
        ...
        >
          ...
          <button className="px-8 py-4 bg-gradient-to-r from-highlight to-accent text-dark font-bold rounded-lg transition-all transform hover:scale-105 active:scale-95">
            Start Your Journey
          </button>
        </motion.div>
      </div>
